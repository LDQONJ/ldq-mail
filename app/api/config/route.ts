  ...
  return NextResponse.json(
    {
      ...
      faviconUrl: branded<string>('faviconUrl', '/branding/LDQMail.svg'),
      appLogoLightUrl: branded<string>('appLogoLightUrl', ''),
      appLogoDarkUrl: branded<string>('appLogoDarkUrl', ''),
      loginLogoLightUrl: branded<string>('loginLogoLightUrl', '/branding/LDQMail.svg'),
      loginLogoDarkUrl: branded<string>('loginLogoDarkUrl', '/branding/LDQMail-white.svg'),
